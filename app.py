...
# TSTALIASID is the default test alias ID
agent_alias_id = os.environ.get("BEDROCK_AGENT_ALIAS_ID", "TSTALIASID")
ui_title = os.environ.get("BEDROCK_AGENT_TEST_UI_TITLE",
                          "Bienvenido al Agente de Metricas de negocio")
